...
public class RetroActivity extends FragmentActivity {
	...
	private String type;
	private GoogleMap gooogleMap;			// Changed implementation to use latest version
...
//				.findFragmentById(R.id.map))).getMap();
		...
		// Had to upgrade this to the Async version since play services 9.2
			...
			public void onMapReady(GoogleMap googleMap)
			{
				...
				googleMap.setOnMapClickListener(new OnMapClickListener() {
					...
					public void onMapClick(LatLng arg0) {
						...
						marker = gooogleMap.addMarker(new MarkerOptions()
